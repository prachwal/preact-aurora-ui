  ...
  return (
    <>
      ...
      <Grid responsive columns={12} gutter={[16, 16]}>
        ...
        <Col xs={12} sm={6} md={6} lg={3}>
          <Card variant="elevated" elevation={2} hoverable title="Revenue" padding="md">
            <div
              style={{
                fontSize: 'var(--font-size-2xl)',
                fontWeight: 'bold',
        ...
        <Col xs={12} sm={6} md={6} lg={3}>
          <Card variant="elevated" elevation={2} hoverable title="Orders" padding="md">
            <div
              style={{
                fontSize: 'var(--font-size-2xl)',
                fontWeight: 'bold',
        ...
        <Col xs={12} sm={6} md={6} lg={3}>
          <Card variant="elevated" elevation={2} hoverable title="Conversion" padding="md">
            <div
              style={{
                fontSize: 'var(--font-size-2xl)',
                fontWeight: 'bold',
        ...
        <Col xs={12} lg={6}>
          <Card title="Recent Activity" variant="elevated" elevation={2} padding="lg">
            <div
              style={{
                display: 'flex',
                flexDirection: 'column',
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    borderBottom: index < 3 ? '1px solid var(--color-outline-variant)' : 'none',
                  }}
                >
                  <span style={{ fontSize: 'var(--font-size-lg)' }}>{activity.icon}</span>
                  <div style={{ flex: 1 }}>
